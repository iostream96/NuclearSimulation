...
namespace NuclearSimulation
{
    class constant
    {
        ...
        public readonly int[] climShape = new int[37]{ 4, 4, 6, 8, 10, 14, 16, 20, 24, 29, 34, 38, 44, 48, 52, 55, 58, 60, 60, 60, 58, 55, 52, 48, 44, 38, 34, 29, 24, 20, 16, 14, 10, 8, 6, 4, 4 };
        public const int climWidth= 37;
        public readonly int[] climHeight = new int[3] { 100, 170, 250 };
    }
}
